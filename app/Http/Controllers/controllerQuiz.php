...
class controllerQuiz extends Controller
{
 ...
 public function dadosPagina2( Request $request){
    ...
    if( $acertos == 5)
    $dados ['mensagem'] = " Parabéns! você acertou todas! Você é um
    verdadeiro swiftie!!";
    else if( $acertos > 4)
    $dados ['mensagem'] = " Muito bom!Você acertou ".$acertos."
    de 5!Parabéns!";
    else if( $acertos > 3)
    $dados ['mensagem'] = "Você conhece um pouco sobre a Tay!Pode melhorar. Você acertou ".$acertos." de 5.";
    else if( $acertos == 2)
    $dados ['mensagem'] = "Baby swifite...Dá pra procurar mais. Você acertou ".$acertos." de 5.";
    else
    $dados ['mensagem'] = "Você não conhece a Taylor, vai ouvir o 1989 TV! Você acertou ".$acertos." de 5.";
